...
#define throw(...) {__at_exception__ = true;__exception_name__=*(#__VA_ARGS__)?#__VA_ARGS__:"Exception";if(__exception_cl__)__curr__--;__exception_cl__=false;longjmp(__try_point__[--__curr__],1);}
